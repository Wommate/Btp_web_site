        ...
        <div className='flex md:flex-row flex-col p-12 w-full'>
            <div className='md:rounded-bl-xl md:rounded-tl-xl md:rounded-tr-none rounded-t-xl md:py-3 py-4 md:px-5 px-4 md:pl-20 md:w-1/2 w-full flex flex-col md:gap-10 gap-10'>
                ...
                <div className='flex flex-col w-full'>
                    <div className='lg:w-3/4 w-64 mx-auto '>
                        <div className='md:h-32 h-28 background-contact-1 flex gap-3 shadow p-6 rounded-2xl'>
                            <PiPhoneCall className='font-bold md:text-5xl text-5xl md:my-3 my-5 bg-[#fcd019] text-white rounded-xl p-2' />
                            <div>
                                <p className='lg:text-base text-sm text-left font-bold text-[#fcd019]'>Appeler maintenant au</p>
                                <p className='lg:text-base text-sm text-white text-left font-bold ml-2'>33 945 22 57</p>
                                <p className='lg:text-base text-sm text-white text-left font-bold'>(+221)77 638 31 06/ 77 544 19 48</p>
                    ...
                    <div className='lg:w-3/4 w-64 mx-auto '>
                        <div className='md:h-32 h-28 background-contact-3 flex gap-3 shadow p-6 rounded-2xl'>
                            ...
                            <div className='md:my-4'>
                                <p className='lg:text-base text-sm text-left font-bold text-[#fcd019]'>Notre adresse</p>
                                <p className='lg:text-base text-sm text-white text-left font-bold'>Quartier Ngane - lot 40 Kaolack</p>
                            </div>
                        </div>
                    </div> 
                </div>
            ...
            <div className='md:w-1/2 p-6 mt-20 md:rounded-r-xl md:rounded-bl-none rounded-b-xl'>
                ...
                <form action="#" method="post" className='flex flex-col gap-5 justify-center'>
                    ...
                    <input type="submit" value="Soumettre" className='p-3 rounded-xl bg-[#fcd019] text-black lg:text-lg text-sm mt-3 font-bold lg:w-1/4 w-1/2 mx-auto hover:shadow-md hover:shadow-[#35c6f4] duration-500' />
                </form>
            </div>
        </div>
    );
