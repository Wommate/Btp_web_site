    ...
    return (
        <div className='flex md:flex-row flex-col p-12 w-full'>
            <div className='md:rounded-bl-xl md:rounded-tl-xl md:rounded-tr-none rounded-t-xl md:py-3 py-20 md:px-5 px-4 md:pl-20 md:w-1/2 w-full flex flex-col md:gap-10 gap-10'>
                ...
                <div className='background-contact-1 flex gap-3 shadow p-6 rounded-2xl md:w-3/4 w-full'>
                ...
                <div className='absolute md:top-[47%] top-[37%] md:left-[22%] left-[40%] bg-[#fcd019] p-4 w-16 h-[58px] rounded-b-full'></div>
                <div className='background-contact-2 flex gap-3 shadow p-6 rounded-2xl md:w-3/4 w-full'>
                ...
                <div className='absolute md:bottom-[105px] bottom-[355px] md:left-[22%] left-[40%] bg-[#fcd019] p-4 w-16 h-[58px] rounded-b-full'></div>
