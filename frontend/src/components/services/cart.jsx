...
const Cart = ({id, title, photo, description}) => {
    return (
        <div className='relative md:w-full rounded-xl inset-0 bg-white bg-opacity box_shadow'>
            <div className='flex flex-col gap-3 px-1 py-5 justify-center rounded-xl h-full' key={id}>
