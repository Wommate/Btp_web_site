                ...
                <div className='p-6 md:rounded-r-xl md:rounded-bl-none rounded-b-xl'>
                    <form action="#" method="post" className='flex flex-col gap-5 justify-center'>
                        ...
                        <div className='flex flex-col gap-1'>
                            <input className='border rounded-xl p-2 placeholder:text-lg placeholder:px-2' type="text" name="subject" id="subject" placeholder='Objet' />
                        </div>
                        <div className='flex flex-col gap-1'>
                            <input className='border rounded-xl p-2 placeholder:text-lg placeholder:px-2' type="tel" name="phone" id="phone" placeholder='Tel' />
                        </div>
                        <div className='flex flex-col gap-1'>
