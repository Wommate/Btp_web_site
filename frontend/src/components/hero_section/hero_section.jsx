  ...
  return (
    <div className="back">
       <div className='w-full h-full bg-black/30 flex flex-col lg:flex-row justify-center items-center'>
            <div className='w-1/2 h-full lg:pl-10 mt-28 lg:mt-0 flex flex-col justify-center items-center gap-3 lg:gap-10' data-aos="fade-right">
                ...
                <div className='flex flex-col items-center lg:items-start gap-4'>
                    ...
                    <Link to="/about" className="px-6 py-3 rounded-lg bg-[#fcd019] text-white font-semibold hover:bg-[#ebbc02]">À propos</Link>
                </div>
            </div>
            <div className='w-1/2 mr-20 lg:mr-0 lg:pt-40 xl:pt-40 hidden md:block ' data-aos="fade-left">
                <img src="img/man1.png" alt="men" loading="lazy" className='w-11/12'/>
            </div>
       </div>
    </div>
  )
